...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/wells?characterEncoding=utf8&serverTimezone=GMT%2B8");
...
//        strategy.setInclude(new String[]{"tb_user","tb_news","tb_comment"});//需要生成的表
}
